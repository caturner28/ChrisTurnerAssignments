...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(test.divisorSum(30));
        System.out.println(test.isStrong(27));
        System.out.println(test.printDivisors(27));
        System.out.println(test.printComposites(28));
        System.out.println(test.printPrime(28));
        System.out.println(test.printStrong(29));
        System.out.println(test.printWeak(29));
